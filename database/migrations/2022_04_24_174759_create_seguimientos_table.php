...
class CreateSeguimientosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('seguimientos', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('estado_seguimiento_id')->nullable();
            $table->foreign('estado_seguimiento_id')->references('id')->on('estado_seguimientos');
            $table->unsignedBigInteger('medio_seguimiento')->nullable();
            $table->foreign('medio_seguimiento')->references('id')->on('medio_seguimientos');
